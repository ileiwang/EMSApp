...
<div class="spaceList adminbody">
    ...
    <div class="admincontent mainform">
        <form name="form" class="form-horizontal" method="post" action="${ctx}/score/teacherAddScoreByCourse">
            <input type="hidden" name="flag" value="2">
            <input type="hidden" name="course_id" value="${requestScope.course.id}">
            <div class="">
                <span>分数：</span>
                <span>
                    <input class="form-control" style="width:300px;" name="score" maxlength="128" value="" type="text">
                </span>
            </div>
