    ...
    <div id="navtop">
      <div class="wp1080">
        ...
        <c:if test="${sessionScope.admin!=null}">
          ...
          <ul><li class="item"><a href="${ctx}/scoremgmt">学生管理</a></li></ul>
          <ul><li class="item"><a href="${ctx}/scoremgmt">教师管理</a></li></ul>
          <ul><li class="item"><a href="${ctx}/scoremgmt">课程管理</a></li></ul>
...
<div class="spaceList adminbody">
    ...
    <div class="admincontent mainform">
        <form name="form" class="form-horizontal" method="post" action="${ctx}/score/updateScore">            
            <input type="hidden" name="flag" value="2">

          	<input class="form-control" style="width:300px;" name="id" value="${requestScope.score.id}" type="hidden">

         <div class="">
                <span>成绩：</span>
                <span>
                    <input class="form-control" style="width:300px;" name="score" value="${requestScope.score.score}" type="number">
                </span>
            </div>
           	...
           	<div class="">
                <span>学生</span>
                <span>
                    <select  name="student_id" class="form-control" style="width:300px;" maxlength="128">
						   <option value="0">选择学生</option>
						   <c:forEach items="${requestScope.students }" var="student">
						   		<c:choose>
			    					<c:when test="${score.student.id == student.id }">
           ...
           <div class="">
                <span>课程</span>
                <span>
                    <select  name="course_id" class="form-control" style="width:300px;" maxlength="128">
						   <option value="0">选择课程</option>
						   <c:forEach items="${requestScope.courses }" var="course">
						   		<c:choose>
			    					<c:when test="${score.course.id == course.id }">
