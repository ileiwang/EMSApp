...
<div class="spaceList adminbody">
    ...
    <div class="admincontent mainform">
        <form name="form" class="form-horizontal" method="post" action="${ctx}/student/avgScoreBetweenAnd">
             <div class="">
                <span>起始区间：</span>
                <span>
					<input class="form-control" id="end" name="start" placeholder="平均分起始区间" type="number" >
                </span>
                 <span>结束区间：</span>
                <span>
					<input class="form-control" id="end" name="end" placeholder="平均分结束区间" type="number">
                </span>
            </div>
