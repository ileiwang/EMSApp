...
<div class="spaceList adminbody">
    ...
    <div class="admincontent mainform">
        <form name="form" class="form-horizontal" method="post" action="${ctx}/college/updateCollege">            
            <input type="hidden" name="flag" value="2">

          	<input class="form-control" style="width:300px;" name="id" value="${requestScope.college.id}" type="hidden">
