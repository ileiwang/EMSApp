...
<div class="spaceList adminbody">
    ...
    <div class="admincontent mainform">
        <form name="form" class="form-horizontal" method="post" action="${ctx}/course/selectCourse">
            ...
            <div class="">
                <span>上课时间：</span>
                <span>
                    <input class="form-control" style="width:300px;" name="day"  value=0 type="number">
                </span>
            </div>
            ...
            <div class="">
                <span>节次：</span>
                <span>
                    <input class="form-control" style="width:300px;" name="coursetime"  type="number" value=0>
                </span>
            </div>
           ...
           <div class="">
                <span>起始周：</span>
                <span>
                    <input class="form-control" style="width:300px;" name="start"  type="number" value=0>
                </span>
            </div>
            <div class="">
                <span>结束周：</span>
                <span>
                    <input class="form-control" style="width:300px;" name="last"  type="number" value=0>
                </span>
            </div>
            <div class="">
                <span>学分：</span>
                <span>
                    <input class="form-control" style="width:300px;" name="credit"  type="number" value=0>
                </span>
            </div>
            ...
            <div class="">
                <span>地点：</span>
                <span>
                    <input class="form-control" style="width:300px;" name="place" maxlength="128" value="" type="text">
                </span>
            </div>
