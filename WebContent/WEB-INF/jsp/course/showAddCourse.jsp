...
<div class="spaceList adminbody">
    ...
    <div class="admincontent mainform">
        <form name="form" class="form-horizontal" method="post" action="${ctx}/course/addCourse">
            ...
            <div class="">
                <span>上课时间：</span>
                <span>
                    <input class="form-control" style="width:300px;" name="day" value="" type="number">
                </span>
            </div>
            ...
            <div class="">
                <span>节次：</span>
                <span>
                    <input class="form-control" style="width:300px;" name="coursetime" value="" type="number">
                </span>
            </div>
           ...
           <div class="">
                <span>起始周：</span>
                <span>
                    <input class="form-control" style="width:300px;" name="start"  value="" type="number">
                </span>
            </div>
                ...
                <span>结束周：</span>
                <span>
                    <input class="form-control" style="width:300px;" name="last" value="" type="number">
                </span>
            </div>
                ...
                <span>学分：</span>
                <span>
                    <input class="form-control" style="width:300px;" name="credit"  value="" type="number">
                </span>
            </div>
