...
<div class="spaceList adminbody">
    ...
    <div class="admincontent mainform">
        <form name="form" class="form-horizontal" method="post" action="${ctx}/clazz/updateClazz">            
            <input type="hidden" name="flag" value="2">

          	<input class="form-control" style="width:300px;" name="id" value="${requestScope.clazz.id}" type="hidden">


        	 <div class="">
                <span>学院编号：</span>
                <span>
                    <input class="form-control" style="width:300px;" name="num" value="${requestScope.clazz.num}" type="text">
                </span>
            </div>
         	<div class="">
                <span>学院名称：</span>
                <span>
                    <input class="form-control" style="width:300px;" name="name" value="${requestScope.clazz.name}" type="text">
                </span>
            </div>
         	...
         	<div class="">
                <span>人数：</span>
                <span>
                    <input class="form-control" style="width:300px;" name="stunum" value="${requestScope.clazz.stunum}" type="number">
                </span>
            </div>
            ...
            <div class="">
                ...
                <span>
                <span>
                    <select name="major_id" class="form-control" style="width:300px;" >
						   <option value="0">选择学院</option>
						   <c:forEach items="${requestScope.majors }" var="major">
						   		<c:choose>
			    					<c:when test="${clazz.major.id == major.id }">
