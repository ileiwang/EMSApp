...
<div class="spaceList adminbody">
    ...
    <div class="admincontent mainform">
        <form name="form" class="form-horizontal" method="post" action="${ctx}/clazz/selectClazz">
         ...
         <div class="">
                <span>班级号：</span>
                <span>
                    <input class="form-control" style="width:300px;" name="num" value="" type="text">
                </span>
            </div>
         	<div class="">
                <span>班级名称：</span>
                <span>
                    <input class="form-control" style="width:300px;" name="name" value="" type="text">
                </span>
            </div>
         	<div class="">
                <span>班级人数：</span>
                <span>
                    <input class="form-control" style="width:300px;" name="stunum" value=0 type="number">
                </span>
            </div>
